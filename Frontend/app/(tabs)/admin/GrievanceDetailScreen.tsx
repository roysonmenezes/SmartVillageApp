...
export default function GrievanceDetailScreen() {
  ...
  return (
    <View className="flex-1 bg-gray-50 p-4">
      {/* Page Heading */}
      <View className="mb-4">
        <Text className="text-2xl font-bold text-center text-[#5e9146] mt-8">
          Grievance Detail
        </Text>
      </View>
      ...
      <View className="bg-white rounded-2xl shadow-md p-4 mb-4 border border-gray-100">
        <Text className="text-xl font-bold text-gray-900">{grievance.title}</Text>
        <Text className="text-gray-700 mt-2">{grievance.description}</Text>
        <Text className="text-sm text-gray-500 mt-2">
          Category: {grievance.category}
        </Text>
      ...
      {/* Status Dropdown */}
      <View className="bg-white rounded-2xl shadow-md p-4 mb-4 border border-gray-100">
        <Text className="font-semibold mb-2 text-gray-800">Status</Text>
        <Picker
          selectedValue={status}
          onValueChange={(val) => setStatus(val)}
          style={{
      ...
      {/* Save Button */}
      <TouchableOpacity
        className="bg-[#5e9146] p-4 rounded-2xl shadow-lg mt-4"
        onPress={handleUpdate}
      >
